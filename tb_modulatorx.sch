...
N 540 -340 580 -340 { lab=c1d3}
N 470 -340 540 -340 {
lab=c1d3}
N 540 -370 580 -370 { lab=c1d4}
N 470 -370 540 -370 {
lab=c1d4}
N 540 -400 580 -400 { lab=c1d1}
N 470 -400 540 -400 {
lab=c1d1}
N 540 -430 580 -430 { lab=c1d2}
N 470 -430 540 -430 {
lab=c1d2}
N 540 -170 580 -170 { lab=c2d3}
N 470 -170 540 -170 {
lab=c2d3}
N 540 -200 580 -200 { lab=c2d4}
N 470 -200 540 -200 {
lab=c2d4}
N 540 -230 580 -230 { lab=c2d1}
N 470 -230 540 -230 {
lab=c2d1}
N 540 -260 580 -260 { lab=c2d2}
N 470 -260 540 -260 {
lab=c2d2}
C {/foss/designs/AC3E_Open3LFCC_V2_repo/xschem/modulatorx.sym} -3350 -130 0 0 {name=MOD1}
C {devices/lab_pin.sym} 580 -340 2 0 {name=l23 sig_type=std_logic lab=c1d3}
C {devices/lab_pin.sym} 580 -370 2 0 {name=l24 sig_type=std_logic lab=c1d4}
C {devices/lab_pin.sym} 580 -400 2 0 {name=l25 sig_type=std_logic lab=c1d1}
C {devices/lab_pin.sym} 580 -430 2 0 {name=l26 sig_type=std_logic lab=c1d2}
...
C {devices/lab_pin.sym} 580 -170 2 0 {name=l49 sig_type=std_logic lab=c2d3}
C {devices/lab_pin.sym} 580 -200 2 0 {name=l50 sig_type=std_logic lab=c2d4}
C {devices/lab_pin.sym} 580 -230 2 0 {name=l51 sig_type=std_logic lab=c2d1}
C {devices/lab_pin.sym} 580 -260 2 0 {name=l52 sig_type=std_logic lab=c2d2}
...
.include /foss/designs/AC3E_Open3LFCC_V2_repo/xschem/Modulatorx.spice
...
* Data_SR (INPUT_SELECTOR) (1) parte (7+5*13)T y dura 5*T     **EN (1) PASAN LAS ENTRADAS DIRECTO A LAS SALIDAS**              
...
Vdata_sr16 sr14 sr16 PULSE (0 1.8 6396n 100p 100p 390n 1e3)
...
Vd13 io_in_21 0 PULSE (0 1.8 8000n 100p 100p 200n 800n)
Vd12 io_in_20 0 PULSE (0 1.8 8000n 100p 100p 350n 800n)
Vd11 io_in_19 0 PULSE (0 1.8 8000n 100p 100p 500n 800n)
Vd10 io_in_18 0 PULSE (0 1.8 8000n 100p 100p 650n 800n)
...
.option scale=1e-6
.control
save \\"V(c1d1)\\" \\"V(c1d2)\\" \\"V(c1d3)\\" \\"V(c1d4)\\" \\"V(io_in_18)\\" \\"V(io_in_19)\\" \\"V(io_in_20)\\" \\"V(io_in_21)\\" \\"V(c2d1)\\" \\"V(c2d2)\\" \\"V(c2d3)\\" \\"V(c2d4)\\"     
tran 39n 10u
